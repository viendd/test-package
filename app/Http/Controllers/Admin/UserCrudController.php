...
class UserCrudController extends CrudController
{
    ...
    public function store()
    {
        ...
        $this->crud->setRequest($this->handleAvatarAdmin($this->crud->getRequest()));
    ...
    public function update()
    {
        ...
        $this->crud->setRequest($this->handleAvatarAdmin($this->crud->getRequest(), $user->avatar));
    ...
    protected function handleAvatarAdmin($request, $path = null)
    {
        $uploadService = app()->make(UploadService::class);
        if ($request->hasFile('image')) {
            $fileName = $uploadService->uploadFile($request, 'user/avatar', 'image');
            if ($fileName) {
                $request->request->set('avatar',$fileName);
                if ($path) $uploadService->removeFile($path);
            }
        }
        return $request;
    }

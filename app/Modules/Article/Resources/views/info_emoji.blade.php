@php
    $reactionLike = $reaction->where('is_like', \App\Modules\Article\Models\Article::IS_LIKE)->pluck('user_id');
    $reactionUnLike = $reaction->where('is_like', \App\Modules\Article\Models\Article::UN_LIKE)->pluck('user_id');
    $markTrust = $mark->where('is_trust', \App\Modules\Article\Models\Article::IS_TRUST)->pluck('user_id');
    $markFake = $mark->where('is_trust', \App\Modules\Article\Models\Article::IS_FAKE);
@endphp
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                @foreach(\App\Modules\Author\Models\Author::whereIn('id', $reactionLike)->get() as $author)
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            @if(!$reactionUnLike->isEmpty())
                <div class="modal-body">
                    @foreach(\App\Modules\Author\Models\Author::whereIn('id', $reactionUnLike)->get() as $author)
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            @if(!$markTrust->isEmpty())
                <div class="modal-body">
                    @foreach(\App\Modules\Author\Models\Author::whereIn('id', $markTrust)->get() as $author)
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            @if(!$markFake->pluck('user_id')->isEmpty())
                <div class="modal-body">
                    @foreach(\App\Modules\Author\Models\Author::whereIn('id', $markFake->pluck('user_id'))->get() as $author)
                        <div class="evident">

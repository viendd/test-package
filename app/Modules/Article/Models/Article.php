...
use App\Models\UserReactionArticle;
...
class Article extends Model
{
    ...
    */
    ...
    {
        return [
            self::STATUS_DRAFT => __('Article::general.draft'),
            self::STATUS_PUBLISHED => __('Article::general.published'),
            self::STATUS_APPROVE => __('Article::general.approved'),
            self::STATUS_PENDING => __('Article::general.pending'),
            self::STATUS_REJECT => __('Article::general.reject')
        ];
    }

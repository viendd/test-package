...
class ArticleCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setListView('Article::index');
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::addColumn(['name' => 'parent_id', 'type' => 'closure', 'label' => __('Category::general.category_parent'), 'function' => function($entry){
            return $entry->category ? $entry->category->name : __('Category::general.category_parent');
        }, 'wrapper'   => [
        ...
        $this->crud->addFilter(
            [
                'name'  => 'categories',
                'type'  => 'select2',
                'label' => __('Category::general.category_name'),
            ],
        ...
        $this->crud->addFilter([ // select2_multiple filter
            ...
            return \App\Modules\Tag\Models\Tag::all()->keyBy('id')->pluck('name', 'id')->toArray();
    ...
    protected function setupCreateOperation()
    {
        ...
        $this->crud->addField([
            'label' => __('Article::general.category'),
        ...
        $this->crud->addField([
            'label' => __('Article::general.title'),
            'type' => 'text',
            'name' => 'title',
        ]);

        $this->crud->addField([
            'label' => __('Article::general.intro_short'),
            'type' => 'text',
            'name' => 'intro_short',
        ]);
        ...
        $this->crud->addField([
            'name' => 'content',
            'label' => __('Article::general.content'),
            'type' => 'ckeditor',
        ...
        $this->crud->addField([
            'label' => __('Article::general.image'),
            'name' => "avatar",
            'type'      => 'upload',
            'upload'    => true,
        ]);

...
//        CRUD::setFromDb(); // columns
        CRUD::column('avatar')->type('image')->label(__('Author::general.avatar'));
        CRUD::column('name')->type('text')->label(__('Author::general.name'));
        ...
        ])->label('Type')->label(__('Author::general.type'));
        CRUD::column('created_at')->type('datetime')->label(__('Author::general.created'));

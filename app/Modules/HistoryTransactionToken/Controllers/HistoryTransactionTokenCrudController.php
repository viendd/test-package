...
namespace App\Modules\HistoryTransactionToken\Controllers;

use App\Modules\HistoryTransactionToken\Models\HistoryTransactionToken;
...
class HistoryTransactionTokenCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(HistoryTransactionToken::class);
        ...
        CRUD::setListView('HistoryTransactionToken::index');
    }

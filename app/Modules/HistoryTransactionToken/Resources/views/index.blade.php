...
@section('content')
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table id="topTable" class="bg-white table table-bordered table-hover nowrap rounded shadow-xs border-xs mt-2" cellspacing="0">
                            ...
                            <tr>
                                <th>{{ __('HistoryTransactionToken::general.index') }}</th>
                                <th>{{ __('HistoryTransactionToken::general.name') }}</th>
                                <th>{{ __('HistoryTransactionToken::general.token') }}</th>
                            </tr>
                            </thead>
                            <tbody>
    ...
    <div class="row">
        ...
        <div class="{{ $crud->getListContentClass() }}">
            <button type="button" class="btn btn-info" data-toggle="modal" data-target=".bd-example-modal-lg" id="top">{{ __('HistoryTransactionToken::general.top_title') }}</button>
